...
Helix ships with all the good stuff built into a single binary. You open a `.rs` file, and you instantly have syntax highlighting, auto-completion, and inline diagnostics. The same goes for typesetting in [Typst](https://typst.app/); the language support is just there, ready to go. It respects your time.
...
[my config](https://github.com/destroyerOfOfficeChairs/helix_config)
